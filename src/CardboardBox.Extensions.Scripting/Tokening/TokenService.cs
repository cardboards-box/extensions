...
/// <summary>
/// A service for parsing tokens from strings
/// </summary>
...
internal class TokenService : ITokenService
{
    ...
    public static bool PreviousWas(string input, string token, int index)
    {
    ...
    public static int IndexOfStart(string input, string token, int startIndex)
    {
    ...
    public static (Token? token, int index) FindNextToken(string input, TokenParserConfig config, int index)
    {
        ...
        var te = IndexOfStart(input, end, ts);
