...
public static class LinqExtensions
{
    ...
    /// <summary>
    /// An instance of the <see cref="System.Random"/> class
    /// </summary>
    ...
    /// <param name="preferred">The predicate to match the elements too</param>
    /// <returns>The first preferred item or the results of <see cref="Enumerable.FirstOrDefault{TSource}(IEnumerable{TSource})"/></returns>
    public static T? PreferredOrFirst<T>(this IEnumerable<T> data, Func<T, bool> preferred)
    {
        foreach (var item in data)
        {
